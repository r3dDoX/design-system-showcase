...
/**
 * @event {DssPaginationPageIndexSelectedEvent} dss-pagination-page-index-selected - Fires when a new page index has been selected
...
export default class Pagination extends BaseElement<PaginationEventsPayloadMap> {
  ...
  override render() {
    ...
    return html`
      ...
      >
        <dss-icon icon="chevrons-left" size="small"></dss-icon>
      </dss-button>
      <dss-button
        type="icon-only"
        ?disabled=${!this.canGetPreviousPage()}
      ...
      >
        <dss-icon icon="chevron-left" size="small"></dss-icon>
      </dss-button>
      ...
      <dss-button
        ...
        @click=${() => this.nextPage()}
      >
        <dss-icon icon="chevron-right" size="small"></dss-icon>
      </dss-button>
      <dss-button
        type="icon-only"
        ?disabled=${!this.canGetNextPage()}
        @click=${() => this.lastPage()}
      >
        <dss-icon icon="chevrons-right" size="small"></dss-icon>
      </dss-button>
    `;
  }
